  ...
  return (
    <header className="h-20 bg-white border-b border-slate-200 px-8 flex justify-between items-center sticky top-0 z-30 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Quick Action Button (Optional but Professional) */}
        ...
        <div className="relative">
          ...
          >
            {/* Teal Avatar */}
            <div className="h-9 w-9 rounded-lg bg-teal-600 flex items-center justify-center text-white font-bold text-sm shadow-inner">
              SA
            </div>
            
            <div className="hidden text-left sm:block">
              <p className="text-sm font-bold text-slate-800 leading-none">Sabbir Ahmed</p>
              <p className="text-[11px] font-medium text-teal-600 mt-1 uppercase tracking-tighter">Super Admin</p>
            </div>
          ...
          {showProfile && (
            <div className="absolute right-0 mt-3 w-60 bg-white border border-slate-200 rounded-2xl shadow-2xl shadow-slate-200/50 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
              ...
              <button className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-slate-600 hover:bg-teal-50 hover:text-teal-700 transition-colors">
